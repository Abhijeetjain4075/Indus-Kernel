...
class TestResearch:
    ...
    def test_irrelevant_sources_return_limitations(self):
        src = ResearchSource(
            source_id="s1", title="about cooking", uri="file://cook",
    ...
    def test_relevant_source_produces_claim(self):
        src = ResearchSource(
            source_id="doc1", title="Physics", uri="file://phys",
    ...
    def test_deduplicates_identical_claims(self):
        s1 = ResearchSource(source_id="a", title="t1", uri="u1",
                            text="Water boils at one hundred degrees at sea level.")
        s2 = ResearchSource(source_id="b", title="t2", uri="u2",
                            text="Water boils at one hundred degrees at sea level.")
    ...
    def test_multiple_relevant_sources(self):
        s1 = ResearchSource(source_id="a", title="t1", uri="u1",
                            text="France Paris is the capital city of France.")
        s2 = ResearchSource(source_id="b", title="t2", uri="u2",
